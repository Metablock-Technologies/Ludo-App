                ...
                <div id="legalterms-container" className="container mx-0">
                    <div className="row">
                        ...
                        <div className="col-12 card my-1 walletcard pt-2 px-0 mx-auto text-white">
                            ...
                            {enable && <div className="card-body walletbody mt-2" id="card-body2" style={{ display: activeCard === 2 ? 'block' : 'none' }}>
                                <div className="row">
                                    <div className="col-12">
                                        <p className="text-light lh-lg">
                        ...
                        <div className="col-12 card my-1 walletcard pt-2 px-0 mx-auto text-white">
                            ...
                            {enable && <div className="card-body walletbody mt-2" id="card-body4" style={{ display: activeCard === 4 ? 'block' : 'none' }} >
                                <div className="row">
                                    <div className="col-12">
                                        <p className="text-light lh-lg">
                                            ...
                                            <br />
                                            Ludo Players is a skill-based real-money gaming platform accessible only for our users in India. It is accessible on <a href="https://ludokavish.com" className="text-warning">https://ludokavish.com</a> . On Ludo Players, users can compete for real cash in Tournaments and Battles. They can encash their winnings via popular options such as Paytm Wallet, UPI or Phonepe.
                                            <br />
                                            ...
                                            <a href="support@ludokavish.com " className="text-warning">support@ludokavish.com </a>
                                        </p>
                                    </div>
                                </div>
                            </div>}
                        ...
                        <div className="col-12 card my-1 walletcard pt-2 px-0 mx-auto text-white">
                            ...
                            {enable && <div className="card-body walletbody mt-2" id="card-body5" style={{ display: activeCard === 5 ? 'block' : 'none' }}>
                                <div className="row">
                                    <div className="col-12">
                                        <p className="text-light lh-lg">
